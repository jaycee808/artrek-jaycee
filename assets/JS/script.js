...
//
const API_URL = "https://api.europeana.eu/record/v2/search.json?wskey=" + EUAPIKey + "&query=rembrandt"

Window.onload = resultsOnload();

// Function to load search result on page load
function resultsOnload() {

  var onloadURL = "https://api.europeana.eu/record/v2/search.json?wskey=" + EUAPIKey + "&query=rembrandt";
...
// Function to search EU API when keyword is entered into search bar
    ...
    <div class="container-fluid">
        <div class="card">
            <a href="${item.link}" target="_blank"><img src="${item.image}" class="card-image-top" alt=""></a>
                ...
                <div class="card-footer bg-transparent border-primary align-self-end">
